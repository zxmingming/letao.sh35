...
$(function() {
    ...
    // 功能使用 localStorage 完成, 使用数组存储 => 因为数组是有顺序的存储
    ...
    */
    ...
    // 功能2: 清空全部的历史记录
    // 思路:
    // (1) 点击清空按钮 (事件委托) => 弹出模态框 (使用插mui插件 ( dialog(对话框) ))
    // (2) 移除本地历史的数据, 使用 removeItme
    // (3) 页面重新渲染
    $('.lt_history').on('click','.btn_empty',function() {

        // 消息提示框
        //confirm(message, title, btnArr, callback)
        // 参数1: message 内容
        // 参数2: title   标题
        // 参数3: btnArr  按钮文本数组
    ...
    $('.lt_history').on('click','.btn_delete',function() {
        ...
        // arr.splice(从哪里开始删, 删几个, 替换的项1, 替换的项2, 替换的项3, ...);
        arr.splice(index, 1);
